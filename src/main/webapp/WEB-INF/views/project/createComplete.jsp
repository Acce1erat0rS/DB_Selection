  ...
  <div class="display-table">
    <div class="display-table-cell vertical-align-middle">
      ...
      <div class="container text-center">
        ...
        <h1 class="fw-600 mt-30 mb-3 wow fadeIn" data-wow-delay="0.6s">课题管理</h1>
        <br>
...
<section class="padding-xlg">
  <div class="container">
    ...
    <h2>课题创建 <strong>成功</strong></h2>
    <a class="size-20 font-lato" href="/project/list"><i class="glyphicon glyphicon-menu-left margin-right-10 size-16"></i> 返回列表</a>
