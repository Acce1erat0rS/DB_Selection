...
<%--</p>--%>
<%--</div>--%>
<%--</div>--%><%@ page import="java.util.Random" %>
    ...
    <div class="display-table">
        <div class="display-table-cell vertical-align-middle">
            ...
            <div class="container text-center">
                ...
                <h1 class="fw-600 mt-30 mb-3 wow fadeIn" data-wow-delay="0.6s">选题成功</h1>
                <br>
...
<section class="padding-xlg">
    <div class="container">
        ...
        <h2>选题 <strong>成功</strong></h2>
        <a class="size-20 font-lato" href="/project/slist"><i class="glyphicon glyphicon-menu-left margin-right-10 size-16"></i> 返回列表</a>
...
<%--<div class="row">--%>
    <%--<div class="col-sm-12">--%>
        <%--<p class="alert alert-success">--%>
            <%--选题成功<br> <a--%>
                <%--href="${pageContext.request.contextPath}/project/slist" class="btn btn-default">Back--%>
            <%--to List</a>--%>
        <%--</p>--%>
    <%--</div>--%>
<%--</div>--%>
