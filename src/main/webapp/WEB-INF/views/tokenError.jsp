<%@ page import="java.util.Random" %><%--&lt;%&ndash;<html>&ndash;%&gt;--%>
<%--&lt;%&ndash;<head>&ndash;%&gt;--%>
<%--&lt;%&ndash;<meta charset="utf-8" />&ndash;%&gt;--%>
<%--&lt;%&ndash;<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />&ndash;%&gt;--%>
<%--&lt;%&ndash;<meta name="viewport" content="width=device-width" />&ndash;%&gt;--%>
<%--&lt;%&ndash;<link rel="stylesheet"&ndash;%&gt;--%>
    <%--&lt;%&ndash;href="${pageContext.request.contextPath}/resources/vendor/bootstrap/dist/css/bootstrap.css" />&ndash;%&gt;--%>
<%--&lt;%&ndash;<link rel="stylesheet"&ndash;%&gt;--%>
    <%--&lt;%&ndash;href="${pageContext.request.contextPath}/resources/vendor/bootstrap/dist/css/bootstrap-theme.css" />&ndash;%&gt;--%>
...
<%--&lt;%&ndash;}&ndash;%&gt;--%>
<%--&lt;%&ndash;</style>&ndash;%&gt;--%>
<%--&lt;%&ndash;<title>TokenError</title>&ndash;%&gt;--%>
<%--&lt;%&ndash;</head>&ndash;%&gt;--%>
<%--&lt;%&ndash;<body>&ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash;<jsp:include page="layout/header.jsp" />&ndash;%&gt;--%>
      <%--&lt;%&ndash;<div class="col-sm-12">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<p class="alert alert-danger">&ndash;%&gt;--%>
          <%--&lt;%&ndash;[<c:choose><c:when test="${not empty exceptionCode}">${f:h(exceptionCode)}</c:when><c:otherwise>${f:h(param.exceptionCode)}</c:otherwise></c:choose>]&ndash;%&gt;--%>
          <%--&lt;%&ndash;Token Error...<br /> <a&ndash;%&gt;--%>
