...
<div class="mainContext" style="overflow: auto;align:center;
margin:0 auto;
width:80%">
 <div class="leftContext" style="float: left;
width: 65%;
border-bottom: 1px solid #BDBDBD">

  <h3><a href="#" onclick="h('intro')" title="单击收起，双击展开" style="outline: none;
  ...
  <div class="intro" id="intro" style="
	color: #333;
	padding-bottom: 35px;
	font-size: 14px;line-height:30px;font-family:Microsoft YaHei" ><p></p><p>
 ...
 <div class="rightContext" style="float: right;
width: 30%;
border-left: 1px solid #BDBDBD">

  <h3><a href="#" style="padding-left:10%;outline: none;
	text-decoration: none;
	-webkit-transition: color 0.3s ease-in-out;
	-moz-transition: color 0.3s ease-in-out;
	transition: color 0.3s ease-in-out"><span class="strip"></span><span style="font-size: 18px;line-height:30px;font-family:Microsoft YaHei;padding-left: 14px;
	border-left: 3px solid #c0c0c0;">教授风采</span></a></h3>
  <div align=center><img src="/static/img/wjx.jpg"></div>
  <p style="line-height:30px;font-size:14px;font-family:Microsoft YaHei;padding-left:10%">
   王建新，男，1972年9月生，北京林业大学信息学院副教授。<br>
   1991.9-1995.7于青岛大学数学系应用数学专业学习，取得理学学士学位<br>
   1995.9-1998.7于北京理工大学数学系应用数学专业学习，取得理学硕士学位<br>
   1998.9-2001.7于北京科技大学信息学院数据挖掘专业学习，取得工学博士学位<br>
   2001.8-2005.3于中科院计算技术研究所和联想研究院进行博士后研究工作<br>
   2005.3-，于北京林业大学信息学院做教学科研工作。2005年9月晋升为副教授，2006年1月被聘为硕士生导师<br>
   先后参与的项目包括：网络安全管理和预警防御系统（863课题编号：2002AA142030)<br>
   数据挖掘和知识发现在农业气象预报中的应用（国家自然科学基金课题号：69835001）<br>
   多信息源智能化安全强审计系统（863课题号：2003AA148020）<br>
   国家石油天然气总公司研究院的国家石油天然气产量预测系统<br>
   联想公司为国家经贸委（现在的国资委）所做的电子政务规划<br>
   “十一五”科技支撑计划课题 “知识组织系统的集成与服务体系研究与实现”<br>
   C++、Java代码同源性鉴别系统代码测试系统，2009年
   优秀青年教师科技支撑专项计划（北京林业大学 YX2010-30）
